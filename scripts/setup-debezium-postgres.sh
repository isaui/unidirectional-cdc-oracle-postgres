...
echo "=================================================="
echo "Debezium PostgreSQL CDC Connector Setup"
echo "=================================================="
...
if [ "$CDC_MODE" != "POSTGRES" ]; then
    echo "⚠️  Skipping PostgreSQL CDC deployment (CDC_MODE=$CDC_MODE)"
    echo "ℹ️  PostgreSQL CDC only active when CDC_MODE=POSTGRES"
    echo "=================================================="
    exit 0
fi

echo "✅ CDC_MODE=POSTGRES - Deploying PostgreSQL CDC connector..."
...
CONNECTOR_CONFIG=$(cat /config/postgres-connector.json | \
...
echo ""
echo "=================================================="
echo "✅ PostgreSQL CDC connector deployed!"
echo "=================================================="
echo "Connector Name: ${CONNECTOR_NAME}"
echo "Connect URL: ${CONNECT_URL}"
echo "Topics: db.postgres.users, db.postgres.user_activities"
echo "=================================================="
